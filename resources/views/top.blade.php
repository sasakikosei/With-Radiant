...
<div class="container mx-auto w-[50rem]">
    ...
    <ul class="list-none mb-6 text-lg font-bold mx-auto mt-8">
        <li class="mb-4">①プロフィールを詳細に書くことで自分に合ったユーザーと繋がることができる  ->  ユーザ一覧</li>
        <li class="mb-4">②募集を投稿することで目的に合ったユーザーを募ることができる  ->  募集一覧</li>
        <li class="mb-8">③一緒に大会を観戦するユーザーを募ることができる  ->  watch party一覧</li>
    </ul>
</div>    
